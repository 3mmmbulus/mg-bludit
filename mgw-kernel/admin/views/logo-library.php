...
<?php
$baseUrl = HTML_PATH_ADMIN_ROOT . 'logo-library';
...
$paginationSummary = $totalItems > 0
    ? sprintf($L->g('logo-library-pagination-summary'), $startIndex, $endIndex, $totalItems)
    : $L->g('logo-library-pagination-empty');
...
<div class="logo-library-page image-library-page asset-library-page container-fluid px-0"
    data-library-page="logo-library"
    data-library-prefix="logoLibrary"
    data-library-source="logo-library"
    data-admin-root="<?php echo HTML_PATH_ADMIN_ROOT; ?>"
    data-confirm-delete="<?php echo Sanitize::html($L->g('logo-library-confirm-delete')); ?>"
    data-confirm-bulk="<?php echo Sanitize::html($L->g('logo-library-confirm-bulk')); ?>"
    data-confirm-title="<?php echo Sanitize::html($L->g('logo-library-confirm-title')); ?>"
    data-confirm-label="<?php echo Sanitize::html($L->g('logo-library-bulk-delete')); ?>"
    data-confirm-cancel="<?php echo Sanitize::html($L->g('logo-library-upload-cancel')); ?>"
    data-error-no-selection="<?php echo Sanitize::html($L->g('logo-library-error-no-selection')); ?>"
    data-error-upload-entity="<?php echo Sanitize::html($L->g('logo-library-error-upload-entity-files')); ?>"
    data-error-upload-link="<?php echo Sanitize::html($L->g('logo-library-error-upload-link-files')); ?>"
    data-error-category-empty="<?php echo Sanitize::html($L->g('logo-library-error-category-empty')); ?>"
    data-error-upload-type="<?php echo Sanitize::html($L->g('logo-library-error-upload-type')); ?>"
...
>
    <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-4" data-library-header>
        <div>
            <h2 class="mb-1">
                <span class="bi bi-badge-tm"></span>
                <span><?php echo $L->g('logo-library-title'); ?></span>
            </h2>
            <p class="text-muted mb-0 small d-flex flex-column flex-lg-row gap-2">
                <span><?php echo $L->g('logo-library-subtitle'); ?></span>
                <span class="text-primary-emphasis">
                    <?php echo $L->g('logo-library-subtitle-hint'); ?>
                </span>
            </p>
        </div>
        <div class="d-flex flex-column flex-md-row align-items-stretch align-items-md-center gap-2">
            <div class="d-flex flex-wrap align-items-center gap-2">
                <button type="button" class="btn btn-primary" data-upload-trigger>
                    ...
                    <span><?php echo $L->g('logo-library-upload-open'); ?></span>
                </button>
                <div class="btn-group" role="group" data-type-switches>
                    <a href="<?php echo Sanitize::html($buildUrl('entity', 1, $currentPerPage)); ?>"
                        ...
                        <span><?php echo $L->g('logo-library-type-entity'); ?></span>
                    ...
                    <a href="<?php echo Sanitize::html($buildUrl('link', 1, $currentPerPage)); ?>"
                        ...
                        <span><?php echo $L->g('logo-library-type-link'); ?></span>
    ...
    <div class="row g-3 mb-4" data-library-overview>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="text-muted small mb-1"><?php echo $L->g('logo-library-entity-count'); ?></div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="text-muted small mb-1"><?php echo $L->g('logo-library-entity-size'); ?></div>
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="h4 mb-0" data-statistic="entity-size"><?php echo Sanitize::html($logoLibrary->formatBytes($entityStats['size'] ?? 0)); ?></div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="text-muted small mb-1"><?php echo $L->g('logo-library-link-count'); ?></div>
                    <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="text-muted small mb-1"><?php echo $L->g('logo-library-link-size'); ?></div>
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="h4 mb-0" data-statistic="link-size"><?php echo Sanitize::html($logoLibrary->formatBytes($linkStats['size'] ?? 0)); ?></div>
    ...
    <div class="card border-0 shadow-sm" data-library-table>
        <div class="card-header bg-white py-3">
            <h6 class="mb-0 text-uppercase text-muted">
                <?php echo $activeType === 'entity' ? $L->g('logo-library-entities-title') : $L->g('logo-library-links-title'); ?>
            </h6>
        </div>
            ...
            <div class="table-responsive">
                <?php if ($activeType === 'entity'): ?>
                    <table class="table table-hover mb-0 align-middle">
                        <thead class="table-light">
                            <tr>
                                <th style="min-width: 280px;"><?php echo $L->g('logo-library-col-name'); ?></th>
                                <th style="width: 200px;"><?php echo $L->g('logo-library-col-category'); ?></th>
                                <th class="text-center" style="width: 120px;"><?php echo $L->g('logo-library-col-size'); ?></th>
                                <th class="text-center" style="width: 180px;"><?php echo $L->g('logo-library-col-uploaded'); ?></th>
                                <th class="text-center" style="width: 120px;"><?php echo $L->g('logo-library-col-actions'); ?></th>
                            ...
                            <?php if (!empty($entries)): ?>
                                <?php foreach ($entries as $entry): ?>
                                    <tr data-entry-row="entity" data-entry-id="<?php echo Sanitize::html($entry['id']); ?>">
                                        ...
                                        <td>
                                            <?php $categoryLabel = isset($entry['category_label']) ? $entry['category_label'] : $L->g('logo-library-category-' . $entry['category']); ?>
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-light text-dark border"><?php echo Sanitize::html($logoLibrary->formatBytes($entry['size'])); ?></span>
                                        </td>
                                        <td class="text-center">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-5">
                                        ...
                                        <span><?php echo $L->g('logo-library-empty-entities'); ?></span>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                ...
                <?php else: ?>
                    <table class="table table-hover mb-0 align-middle">
                        <thead class="table-light">
                            <tr>
                                <th style="min-width: 320px;"><?php echo $L->g('logo-library-col-name'); ?></th>
                                <th style="width: 120px;" class="text-center"><?php echo $L->g('logo-library-col-category'); ?></th>
                                <th style="width: 120px;" class="text-center"><?php echo $L->g('logo-library-col-quantity'); ?></th>
                                <th style="width: 110px;" class="text-center"><?php echo $L->g('logo-library-col-size'); ?></th>
                                <th style="width: 160px;" class="text-center"><?php echo $L->g('logo-library-col-uploaded'); ?></th>
                                <th style="width: 120px;" class="text-center"><?php echo $L->g('logo-library-col-actions'); ?></th>
                                <th style="width: 40px;" class="text-center">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="7" class="text-center text-muted py-5">
                                        ...
                                        <span><?php echo $L->g('logo-library-empty-links'); ?></span>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
            ...
            <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                ...
                <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-md-end flex-wrap gap-2">
                    <form id="imageLibraryPerPageForm" method="get" class="d-flex align-items-center gap-2 mb-0">
                        ...
                        <label class="form-label mb-0 small text-muted text-nowrap" for="imageLibraryPerPageSelect"><?php echo $L->g('logo-library-pagination-per-page'); ?></label>
                        ...
                        <nav class="order-0">
                            <ul class="pagination pagination-sm mb-0 justify-content-center justify-content-md-end">
                                ...
                                if ($currentPageNumber === 1) {
                                    echo '<li class="page-item disabled"><span class="page-link">' . Sanitize::html($L->g('logo-library-pagination-prev')) . '</span></li>';
                                } else {
                                    echo '<li class="page-item"><a class="page-link" href="' . Sanitize::html($buildUrl($activeType, $prevPage, $currentPerPage)) . '">' . Sanitize::html($L->g('logo-library-pagination-prev')) . '</a></li>';
                                }
                                ...
                                if ($currentPageNumber === $totalPages) {
                                    echo '<li class="page-item disabled"><span class="page-link">' . Sanitize::html($L->g('logo-library-pagination-next')) . '</span></li>';
                                } else {
                                    echo '<li class="page-item"><a class="page-link" href="' . Sanitize::html($buildUrl($activeType, $nextPage, $currentPerPage)) . '">' . Sanitize::html($L->g('logo-library-pagination-next')) . '</a></li>';
                                }
                                ?>
                            </ul>
                        </nav>
                    ...
                    <button type="button" class="btn btn-outline-danger btn-sm" data-bulk-delete disabled>
                        ...
                        <span class="ms-1"><?php echo $L->g('logo-library-bulk-delete'); ?></span>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo $L->g('logo-library-upload-title'); ?></h5>
            ...
            <form id="imageLibraryUploadForm" method="post" enctype="multipart/form-data" data-no-spa="true">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <span class="form-label d-block"><?php echo $L->g('logo-library-upload-mode'); ?></span>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="uploadLibraryMode" id="logoUploadTypeEntity" data-upload-type="entity">
                                <label class="form-check-label" for="logoUploadTypeEntity"><?php echo $L->g('logo-library-upload-mode-entity'); ?></label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="uploadLibraryMode" id="logoUploadTypeLink" data-upload-type="link">
                                <label class="form-check-label" for="logoUploadTypeLink"><?php echo $L->g('logo-library-upload-mode-link'); ?></label>
                            </div>
                            <div class="form-text"><?php echo $L->g('logo-library-upload-mode-hint'); ?></div>
                        </div>
                        <div class="col-md-4">
                            <label for="logoUploadCategorySelect" class="form-label"><?php echo $L->g('logo-library-upload-category'); ?></label>
                            <select class="form-select" id="logoUploadCategorySelect" data-category-select>
                                <?php foreach ($fixedCategoryOptions as $option): ?>
                                    <option value="<?php echo Sanitize::html($option); ?>" <?php echo $option === $defaultCategoryValue ? 'selected' : ''; ?>>
                                        <?php echo Sanitize::html($L->g('logo-library-category-' . $option)); ?>
                                    </option>
                                <?php endforeach; ?>
                                <option value="__custom__"><?php echo Sanitize::html($L->g('logo-library-upload-category-custom')); ?></option>
                            </select>
                            <input type="text" class="form-control mt-2 d-none" id="logoUploadCategoryCustom" data-category-custom placeholder="<?php echo Sanitize::html($L->g('logo-library-upload-category-placeholder')); ?>">
                            ...
                            <div class="form-text"><?php echo $L->g('logo-library-upload-category-hint'); ?></div>
                        </div>
                        <div class="col-md-4">
                            <label for="uploadFiles" class="form-label"><?php echo $L->g('logo-library-upload-files'); ?></label>
                            <input type="file" class="form-control" id="uploadFiles" name="files[]" multiple required>
                            <div class="form-text d-none" data-upload-hint-entity><?php echo $L->g('logo-library-upload-entity-desc'); ?></div>
                            <div class="form-text d-none" data-upload-hint-link><?php echo $L->g('logo-library-upload-link-desc'); ?></div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo $L->g('logo-library-upload-cancel'); ?></button>
                    <button type="submit" class="btn btn-primary disabled" disabled>
                        <span class="spinner-border spinner-border-sm align-middle me-2 d-none" role="status" aria-hidden="true"></span>
                        <span class="label-text"><?php echo $L->g('logo-library-upload-submit'); ?></span>
                    </button>
                </div>
            </form>
        </div>
